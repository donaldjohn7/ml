...
<div id="headgal">
  ...
  <div id="bible_focus_wrapper">
    <div class="bible_focus">
        <?php 
          $otherFeaturedPost = new WP_Query();
          $otherFeaturedPost->query('showposts=5&cat='.get_option('recenttips').'&offset=0'); 
        ?> 
        <?php 
          while ($otherFeaturedPost->have_posts()) : $otherFeaturedPost->the_post(); 
        ?> 
        <div class="bible_focus_content">
          <div id="bible_focus_pad">
            <a href="<?php the_permalink() ?>" title="<?php the_title(); ?>"><?php the_title(); ?></a><?php the_content_limit(110); ?> 
            <div class="timeago"><?php echo human_time_diff(get_the_time('U'), current_time('timestamp')) . ' ago'; ?><span id="commentbuble"><?php comments_popup_link('0', '1', '%'); ?></span> </div>
          </div>
        </div>
        <?php $c++; endwhile; wp_reset_query(); ?>     
      </div>
...
<?php } ?>
    ...
    <div id="indextopleft">
      <div>
        ...
        <div class="indextopleftslide" style="height: 270px">
          ...
          <div class="indextopleftabsolute">
      ...
      <div id="twocats">
        <div id="twocatsleft">
          ...
          <div class="indextopleftslide">
            ...
            <div class="indextopleftabsolute1">
              <h3><?php the_category(' ') ?></h3>
              <h2><a href="<?php the_permalink() ?>" title="<?php the_title(); ?>"><?php the_title(); ?></a></h2>
            </div>
          </div>
        ...
        <div id="twocatsright">
          ...
          <div class="indextopleftslide">
            <a href="<?php the_permalink() ?>" title="<?php the_title(); ?>">  <?php the_post_thumbnail( 'indextoptwocat', 'title='.get_option('title').'' ); ?>  </a>
            <div class="indextopleftabsolute2">
              <h3><?php the_category(' ') ?></h3>
              <h2><a href="<?php the_permalink() ?>" title="<?php the_title(); ?>"><?php the_title(); ?></a></h2>
            </div>
          </div>
  ...
  <div id="homepost">
    ...
    <?php if(get_option('ad2ok')!="no"):?> 
    <center>  <?php echo get_option('ad2'); ?> </center>
    <?php endif?> 
    ...
    <article class="post">
      ...
      <div class="pmeta">
        ...
        <div id="socialblog">
          ...
          <div id="fblog"> 
            <iframe src="http://www.facebook.com/plugins/like.php?href=<?php echo urlencode(get_permalink($post->ID)); ?>&amp;layout=button_count&amp;show_faces=false&amp;width=75&amp;action=like&amp;colorscheme=light&amp;height=21" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:78px; height:21px;" allowTransparency="true"></iframe>  
          </div>
          <div id="cb"></div>
        </div>
        <div id="cb"></div>
