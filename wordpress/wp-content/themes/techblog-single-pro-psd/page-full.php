...
<div id="headgal">
   ...
   <div id="content" style="width: 100% !important;">
      ...
      <article class="post">
         ...
         <div class="entry" style="width: 970px !important;">
            <?php the_content(); ?>
         </div>
      ...
      <div id="related" class="clearfix">
         <div id="sharemark">
            ...
            <div class="share">
               <ul>
                  <li>  <a href="http://delicious.com/save" onclick="window.open('http://delicious.com/save?v=5&amp;noui&amp;jump=close&amp;url='+encodeURIComponent('<?php the_permalink() ?>')+'&amp;title='+encodeURIComponent('<?php the_title() ?>'),'delicious', 'toolbar=no,width=550,height=550'); return false;"> 
                  ...
                  <li>
                     ...
                     <img src="<?php bloginfo('template_directory'); ?>/images/friendfeed.png" alt="Share on FriendFeed" border="0" /></a> 
                  </li>
                  <li>
