...
<div id="wrapper">
		...
		<div id='top_menu_wrapper'>
			...
			<div id="topmenuright">
		 		<ul>
		 			...
		 			<li class="rssnav">
		 				<a href="<?php echo get_option('feedlink'); ?>">RSS</a>
		 			</li>
		 			<li>
		 				<a href="<?php echo get_option('feedemail'); ?>">Newsletter</a>
		 			</li>
		 		</ul>
			</div>
		</div>
    ...
    <div id="logowrap">
    	<div id="logo_wrap_wrapper">
		    <div id="logo">
		    	<a href="<?php echo get_option('home'); ?>">
		    		<img src="<?php bloginfo('template_directory'); ?>/images/ml-logo.png" alt="<?php echo get_option('logoalt'); ?>" />
		    	</a>	    	
		    </div>
		    <nav>
			    <div id="navigation">
		    ...
		    <div id="logohead">
	     	...
	     	<ul>   
	     		<li>  
		     		<a href="<?php echo get_option('facebooklink'); ?>" target="_blank">
		     			<img src="<?php bloginfo('template_directory'); ?>/images/facebook.png" alt="Become a Fan!" style="height:18px;"/>
		     		</a>
	     		</li>
	 			<li> 
	   				<a href="http://twitter.com/<?php echo get_option('twitterlink'); ?>" class="tip_trigger">
		   				<img src="<?php bloginfo('template_directory'); ?>/images/twitter.png" alt="Follow On Twitter" style="height:22px;"/>
		   				<span class="tip">    
			   				<ul id="twitter_update_list">
			    			</ul>
			    			<script type="text/javascript" src="http://twitter.com/javascripts/blogger.js"></script>
			    			<script type="text/javascript" src="http://twitter.com/statuses/user_timeline/<?php echo get_option('twitterlink'); ?>.json?callback=twitterCallback2&count=1"></script>
						</span>
					</a>
	     		</li>
	      		<li> 
		      		<a href="<?php echo get_option('feedlink'); ?>">
		      			<img src="<?php bloginfo('template_directory'); ?>/images/feed.png" alt="Subcribe to Our RSS Feed" style="height:20px;"/>
		      		</a>
	      		</li>
	     	</ul>
     	</div>
