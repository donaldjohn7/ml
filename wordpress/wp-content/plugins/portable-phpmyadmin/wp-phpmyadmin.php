...
*/
define('PORTABLE_PHPMYADMIN_VERSION', '1.3.2.2');
...
<div class="wrap">
	...
	<div class="widefat">
		<iframe width="100%" height="800" name="pmaframe" src="<?php echo PMA_PLUGIN_URL; ?>/pma/index.php?call=<?php echo md5(PORTABLE_PHPMYADMIN_VERSION); ?>" frameborder="0" seamless="seamless"></iframe>
	</div>
